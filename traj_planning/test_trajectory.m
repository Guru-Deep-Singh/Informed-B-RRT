...
for iter = 1:max_iter
    ...
    for qn = 1:nquad
        ...
        if iter == 1
            ...
            h_title = title(sprintf('simulation iterations: %d, time of simulation: %4.2f', iter, time));
%             h_title = title(sprintf('iteration: %d, time: %4.2f', iter, time));
    ...
    set(h_title, 'String', sprintf('simulation iterations: %d, time of simulation: %4.2f', iter, time + cstep))
